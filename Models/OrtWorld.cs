class OrtWorld {
    ...
    static public List<string> ListaHotles {get; private set;} = new List<string> {"~/img/hotel00.jfif","~/img/hotel01.jfif","~/img/hotel02.jfif","~/img/hotel03.jfif","~/img/hotel04.jfif","~/img/hotel06.jfif","~/img/hotel06.jfif","~/img/hotel05.jfif","~/img/hotel08.jfif","~/img/hotel09.jfif"};
